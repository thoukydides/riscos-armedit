<*
    ...
    Description : Supplementary macro definitions for the ARMEdit
                  documentation.
...
<$macro OSLIBMENTION>
    A comprehensive <NAME>OSLib</NAME> interface to all of the <ARMEDIT> SWIs and WIMP messages is included as part of the source code release.
</$macro>