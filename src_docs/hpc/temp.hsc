...
<PAGE TITLE="HPC Services" SUBTITLE="HPC_ARMEDIT_TEMPORARY" PARENT=":hpc/index.html" KEYWORDS="HPC,High-level Procedure Call">

<HPC NAME="HPC_ARMEDIT_TEMPORARY" ID="0105" NUM="001B" DESC="Produce a unique filename for a temporary RISC OS file">
